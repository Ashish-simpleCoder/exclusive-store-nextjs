...
export default function Footer() {
   return (
      <footer className='bg-black text-white'>
         <Container className='pt-7 lg:pt-[47px] pb-3 lg:pb-[27px]'>
            <div className='flex lg:justify-between flex-wrap gap-8 xl:gap-20'>
               {/* <div className='grid xl:grid-cols-5'> */}
               <div>
                  <h3 className={`${inter.className} font-bold text-2xl leading-6 tracking-[3%] mb-6`}>Exclusive</h3>
                  <p className={`${poppins.className} font-medium text-xl leading-7 mb-6`}>Subscribe</p>
                  <p className={`${poppins.className} mb-4 !text-[#FAFAFA]`}>Get 10% off your first order</p>
                  <div className='relative '>
                     <VisuallyHidden as='label' htmlFor='subscribe'>
                        Subscribe
                     </VisuallyHidden>
                     <input
                        type='text'
                        ...
                        className={
                           poppins.className +
                           ' rounded-md relative bg-black px-5 py-2 w-[217px] border-[1px] border-white'
                        }
                     />
                     <button className='absolute right-5 top-1/2 -translate-y-1/2'>
                        <VisuallyHidden>Subscribe Email</VisuallyHidden>
                        <IoSend size='24' />
                     </button>
                  </div>
               </div>
               ...
               <div className='g-2'>
                  <h3 className={`${inter.className} font-bold text-2xl leading-6 tracking-[3%] mb-6`}>Support</h3>
                  <p className={`${poppins.className} mb-4 !text-[#FAFAFA]`}>
                     111 Bijoy sarani, Dhaka, <br /> DH 1515, Bangladesh.
                  </p>
                  <p className={`${poppins.className} mb-4 !text-[#FAFAFA]`}>exclusive@gmail.com</p>
                  <p className={`${poppins.className} mb-4 !text-[#FAFAFA]`}>+88015-88888-9999</p>
               </div>

               <div className='g-3'>
                  <h3 className={`${inter.className} font-bold text-2xl leading-6 tracking-[3%] mb-6`}>Account</h3>
                  <p className={`${poppins.className} mb-4 !text-[#FAFAFA]`}>My Account</p>
                  <p className={`${poppins.className} mb-4 !text-[#FAFAFA]`}>Login / Register</p>
                  <p className={`${poppins.className} mb-4 !text-[#FAFAFA]`}>Cart</p>
                  <p className={`${poppins.className} mb-4 !text-[#FAFAFA]`}>Wishlist</p>
                  <p className={`${poppins.className} mb-4 !text-[#FAFAFA]`}>Shop</p>
               </div>

               <div className='g-4'>
                  <h3 className={`${inter.className} font-bold text-2xl leading-6 tracking-[3%] mb-6`}>Quick Link</h3>
                  <p className={`${poppins.className} mb-4 !text-[#FAFAFA]`}>Privacy Policy</p>
                  <p className={`${poppins.className} mb-4 !text-[#FAFAFA]`}>Terms Of Use</p>
                  <p className={`${poppins.className} mb-4 !text-[#FAFAFA]`}>FAQ</p>
                  <p className={`${poppins.className} mb-4 !text-[#FAFAFA]`}>Contact</p>
               </div>

               <div className='g-5'>
                  <h3 className={`${inter.className} font-bold text-2xl leading-6 tracking-[3%] mb-6`}>Download App</h3>
                  <p className={`${poppins.className} text-xs mb-4 text-[#FAFAFA] text-opacity-70`}>
                  ...
                  <div className='flex justify-between max-w-40'>
                     ...
                     <Link href='/'>
                        <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
                           <g clip-path='url(#clip0_928_1563)'>
                              <path
         ...
         <Container className='py-4 text-center'>
            <p className={`${poppins.className} opacity-70`}>&copy; Copyright Exclusive 2022. All right reserved</p>
         </Container>
      </footer>
   )
}
