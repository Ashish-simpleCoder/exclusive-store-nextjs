...
const categories = [
         ...
         <svg width='56' height='56' viewBox='0 0 56 56' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
            <g clip-path='url(#clip0_928_868)'>
               ...
               <path
                  ...
                  stroke-linejoin='round'
               />
               <line x1='15.1667' y1='39.8334' x2='40.8333' y2='39.8334' stroke='current' stroke-width='2' />
            </g>
            <defs>
               <clipPath id='clip0_928_868'>
   ...
   },
   {
      id: 2,
      name: 'Computers',
      img: (props: ComponentProps<'svg'>) => (
         <svg width='56' height='56' viewBox='0 0 56 56' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
            <g clip-path='url(#clip0_928_613)'>
               <path
               ...
               <path
                  ...
                  stroke-linejoin='round'
               />
               <path d='M8 32H48' stroke='current' stroke-width='2' stroke-linecap='round' />
            </g>
            <defs>
               <clipPath id='clip0_928_613'>
                  <rect width='56' height='56' fill='white' />
               </clipPath>
            </defs>
         </svg>
         ...
         <svg width='56' height='56' viewBox='0 0 56 56' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
            <g clip-path='url(#clip0_928_629)'>
               ...
               <path
                  ...
                  stroke-linejoin='round'
               />
               <line x1='24' y1='23' x2='24' y2='34' stroke='current' stroke-width='2' stroke-linecap='round' />
               <line x1='28' y1='28' x2='28' y2='34' stroke='current' stroke-width='2' stroke-linecap='round' />
               <line x1='32' y1='26' x2='32' y2='34' stroke='current' stroke-width='2' stroke-linecap='round' />
            </g>
            <defs>
               <clipPath id='clip0_928_629'>
                  <rect width='56' height='56' fill='white' />
               </clipPath>
            </defs>
         </svg>
