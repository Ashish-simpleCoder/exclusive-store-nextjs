...
export default function AboutPage() {
   return (
      <main className='flex min-h-screen flex-col items-center'>
         ...
         <Container As='section' className='sales-info max-xl:w-full py-10'>
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-[30px]'>
               <div className='border border-black border-opacity-70 py-[30px]  rounded-md flex flex-col items-center hover:border-white hover:shadow-md hover:bg-red-secondary hover:text-white transition-colors'>
                  <div className='mb-6'>
                  ...
                  <h3 className={`${inter.className} font-bold text-[32px] leading-[30px] pb-2`}>10.5K</h3>
                  <p className={`${poppins.className}`}>Sallers active at our site</p>
               </div>
               ...
               <div className='border border-black border-opacity-70 py-[30px]  rounded-md flex flex-col items-center hover:border-white hover:shadow-md hover:bg-red-secondary hover:text-white transition-colors'>
                  ...
                  <h3 className={`${inter.className} font-bold text-[32px] leading-[30px] pb-2`}>33K</h3>
                  <p className={`${poppins.className}`}>Sallers Monthly Produduct Sale</p>
               </div>
               ...
               <div className='border border-black border-opacity-70 py-[30px]  rounded-md flex flex-col items-center hover:border-white hover:shadow-md hover:bg-red-secondary hover:text-white transition-colors'>
                  ...
                  <h3 className={`${inter.className} font-bold text-[32px] leading-[30px] pb-2`}>45K</h3>
                  <p className={`${poppins.className} text-base`}>Customer active in our site</p>
               </div>

               <div className='lg:col-span-3 xl:col-span-1 border border-black border-opacity-70 py-[30px]  rounded-md flex flex-col items-center hover:border-white hover:shadow-md hover:bg-red-secondary hover:text-white transition-colors'>
                  <div className='mb-6'>
                     <svg width='81' height='80' viewBox='0 0 81 80' fill='none' xmlns='http://www.w3.org/2000/svg'>
                        <path
                           opacity='0.3'
                  ...
                  <h3 className={`${inter.className} font-bold text-[32px] leading-[30px] pb-2`}>25K</h3>
                  <p className={`${poppins.className}`}>Annual gross sale in our site</p>
               </div>
            </div>
         </Container>
      </main>
